from aif360.datasets import AdultDataset, MyAdultDataset, GermanDataset, CompasDataset
import pandas as pd
import numpy as np
...
def load_preproc_data_adult_modified(protected_attributes=None):
    def custom_preprocessing(df):
        """The custom pre-processing function is adapted from
            https://github.com/fair-preprocessing/nips2017/blob/master/Adult/code/Generate_Adult_Data.ipynb
        """
    ...
    # XD_features = ['Age (decade)', 'Education Years', 'sex', 'race']
    XD_features = ['age', 'workclass', 'fnlwgt', 'education', 'marital-status', 'occupation','race', 'sex', 'capitalgain', 'capitalloss', 'hoursperweek','native-country', 'target']
...
def load_preproc_data_german_original(protected_attributes=None):
    """
