...
from load_compas_score_as_labels import load_fair_representations, dist
...
data_sets = load_fair_representations(perm, train_features, train_labels, real_accuracy=real_accuracy, debiased_real_accuracy=debiased_real_accuracy, debiased_test=debiased_test)
