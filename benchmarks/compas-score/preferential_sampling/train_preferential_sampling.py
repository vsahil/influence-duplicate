...
from load_compas_score_as_labels import before_preferential_sampling, resampled_dataset, dist
...
data_sets_final = resampled_dataset(perm, dep_neg_candidates, dep_pos_candidates, fav_neg_candidates, fav_pos_candidates, real_accuracy=real_accuracy, debiased_real_accuracy=debiased_real_accuracy, debiased_test=debiased_test)
