...
from load_salary import disparate_removed_load_salary, dist
...
data_sets, mins_and_ranges = disparate_removed_load_salary(perm = perm, debiased_test=debiased_test)
