...
df_.to_csv("normalized_disparateremoved_features-compas.csv", index=False, header=False)
target.to_csv("normalized_disparateremoved_labels-compas.csv", index=False, header=False)
