...
from load_compas_two_year import disparate_removed_load_compas
...
data_sets = disparate_removed_load_compas(perm = perm)
...
model = Fully_Connected(
    ...
    model_name=f"compas_count{model_count}",
    scheme = f"{scheme}"
    )
...
with open("results_disparate_removed_compas.csv", "a") as f:
    f.write(f'{h1units},{h2units},{batch},{perm},{train_acc*100},{test_acc*100},{num_dicsm},{num_dicsm/10000.0}\n')
