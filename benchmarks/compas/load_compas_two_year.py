...
def load_compas_two_year(perm=-1, validation_size=0):
	total_dataset = pd.read_csv("../../compas-dataset/normalized_compas_two_year_features.csv").to_numpy()
	total_labels = pd.read_csv("../../compas-dataset/compas_two_year_labels.csv").to_numpy()
