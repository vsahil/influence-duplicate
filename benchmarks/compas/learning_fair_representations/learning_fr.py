...
labels = new_df['two_year_recid'].to_numpy()
features = new_df.drop(columns=['two_year_recid']).to_numpy()
...
from load_compas_two_year import load_fair_representations
...
with open("results_lfr_compas.csv", "a") as f:
