...
model = Fully_Connected(
    ...
    mini_batch=True,
    train_dir=f'trained_models_scheme{scheme}/output_count{model_count}', 
    log_dir=f'throw/log{model_count}',
    hvp_files = f"HVP_files_scheme{scheme}/inverse_HVP_schm{scheme}_count{model_count}",
    model_name=name,
    scheme = f"{scheme}")
...
ranked_influential_training_points = f"ranking_points_ordered_scheme{scheme}/{name}.npy"
