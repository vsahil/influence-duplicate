...
from load_german_credit import disparate_removed_load_german, dist
...
data_sets, mins_and_ranges = disparate_removed_load_german(perm = perm, debiased_test=debiased_test)
...
# print("Discrimination:", num_dicsm)
# size = class0_data.shape[0]/100
# with open("results_disparate_removed_german.csv", "a") as f:
