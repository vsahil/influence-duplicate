import pandas as pd
import numpy as np
df = pd.read_csv("disparate_impact_removed_compas_ground.csv")
...
df_.to_csv("normalized_disparateremoved_features-compas_ground.csv", index=False, header=True)
target.to_csv("normalized_disparateremoved_labels-compas_ground.csv", index=False, header=True)
