...
data_sets = load_adult_race_partial_method1(perm=perm, model_count=model_count, train_pts_removed=train_pts_removed[0], name=name, debiased_test=debiased_test)
...
model = Fully_Connected(
    ...
    log_dir=f'throw',
    hvp_files = f'inverse_HVP_adult_race_try',
    model_name=name,
    scheme = f"{scheme}")
