...
from load_adult_race import disparate_removed_load_adult_race, dist
...
data_sets, mins_and_ranges = disparate_removed_load_adult_race(perm = perm, debiased_test=debiased_test)
...
model = Fully_Connected(
    ...
    model_name=f"adult_race_count{model_count}",
    scheme = f"{scheme}"
    )
