...
# # l = 20 * 3 * 2 * 2 
# # l = [i for i in range(1, 26)]      # upto 25% removal in steps of 0.2%
# l = [i for i in range(0, 40)]      # upto 40 points removed
# # mr = pool.map_async(run_command, l)
# settings = [i for i in range(120)]       # for first 120 settings in total
