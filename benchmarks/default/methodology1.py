...
from load_default import load_default_partial_method1, dist
...
data_sets = load_default_partial_method1(perm=perm, model_count=model_count, train_pts_removed=train_pts_removed[0], name=name, debiased_test=debiased_test)
...
model = Fully_Connected(
    ...
    log_dir=f'throw',
    hvp_files = f'inverse_HVP_default_try',
