...
# def create_setting():
#     import pandas as pd
#     df = pd.read_csv("../adult-dataset/adult_no_missing.csv")
...
#     print("command: python nothing.py")
#     exit(0)
# create_setting()



f = open("adult_race_settings.txt",'r')
software_name = ""
command = ""
num_attributes = -1
names = {}
...
# soft.single_feature_discm_adult_race(6, 0.3, 0.99, 0.01, "causal")     # 7th feature is race
soft.single_feature_discm_adult_race_dist(6, 0.3, 0.99, 0.01, "causal")     # 7th feature is race
