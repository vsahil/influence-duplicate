...
# def create_setting():
#     import pandas as pd
#     df = pd.read_csv("../salary-dataset/salary.csv")
...
# soft.single_feature_discm_salary(0, 0.3, 0.99, 0.01, "causal")     # 1st feature is sex
soft.single_feature_discm_salary_dist(0, 0.3, 0.99, 0.01, "causal")     # 1st feature is sex
